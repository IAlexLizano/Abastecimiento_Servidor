...
namespace Identity.Repository
{
    ...
    public class AccountRepository : IAccountRepository
    {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request)
        {
            ...
            var usuario = await _dbContext.Set<RegisteredUser>()
                .AsNoTracking()
                .Include(u => u.UserRole)
                    .ThenInclude(ur => ur.IdRoleNavigation)
                .FirstOrDefaultAsync(u => u.Username.ToUpper().Equals(request.User.ToUpper()));
            ...
            {
                claims.Add(new Claim("RoleId", rol.IdRole.ToString()));
                claims.Add(new Claim(ClaimTypes.Role, rol.IdRoleNavigation.Name));
            }
