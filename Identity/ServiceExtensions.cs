    ...
    public static class ServiceExtensions
    {
            ...
            IConfiguration configuration)
        {
            ...
            services
                ...
                {
                    options.RequireHttpsMetadata = !string.Equals(Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT"), "Development", StringComparison.OrdinalIgnoreCase);
            ...
            services.AddTransient<IHashingRepository, HashingRepository>();
